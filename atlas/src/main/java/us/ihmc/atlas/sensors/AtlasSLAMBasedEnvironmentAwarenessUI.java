...
//TODO: merge with SLAMBasedEnvironmentAwarenessUI.
public class AtlasSLAMBasedEnvironmentAwarenessUI
{
   ...
   private AtlasSLAMBasedEnvironmentAwarenessUI(REAUIMessager uiMessager, Stage primaryStage, RobotContactPointParameters<RobotSide> contactPointParameters)
         throws Exception
   {
      ...
      depthFrameViewer = new SensorFrameViewer<StereoVisionPointCloudMessage>(uiMessager, SLAMModuleAPI.DepthPointCloudState,
      ...
      pelvisFrameViewer = new SensorFrameViewer<StampedPosePacket>(uiMessager, SLAMModuleAPI.CustomizedFrameState, SLAMModuleAPI.UISensorPoseHistoryFrames,
   ...
   public static AtlasSLAMBasedEnvironmentAwarenessUI creatIntraprocessUI(Stage primaryStage, RobotContactPointParameters<RobotSide> contactPointParameters)
         throws Exception
   {
      Messager moduleMessager = KryoMessager.createIntraprocess(SLAMModuleAPI.API, NetworkPorts.SLAM_MODULE_UI_PORT,
                                                                REACommunicationProperties.getPrivateNetClassList());
      REAUIMessager uiMessager = new REAUIMessager(moduleMessager);
      return new AtlasSLAMBasedEnvironmentAwarenessUI(uiMessager, primaryStage, contactPointParameters);
   }
}
