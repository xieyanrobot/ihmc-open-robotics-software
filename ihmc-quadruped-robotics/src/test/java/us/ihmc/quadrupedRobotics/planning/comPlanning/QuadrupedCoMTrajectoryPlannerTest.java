...
import us.ihmc.comTrajectoryPlanning.SettableContactStateProvider;
...
public class QuadrupedCoMTrajectoryPlannerTest
{
   ...
   public void construct()
   {
      ...
      planner = new QuadrupedCoMTrajectoryPlanner(new TestDCMPlannerParameters(), soleFrames, gravityZ, nominalHeight,
                                                                                registry);
   }
