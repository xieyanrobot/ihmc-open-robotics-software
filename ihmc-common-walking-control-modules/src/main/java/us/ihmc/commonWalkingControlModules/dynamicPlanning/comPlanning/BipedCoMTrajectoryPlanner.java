...
import us.ihmc.comTrajectoryPlanning.CoMTrajectoryPlanner;
import us.ihmc.comTrajectoryPlanning.CoMTrajectoryPlannerInterface;
...
public class BipedCoMTrajectoryPlanner
{
   ...
   private final YoFrameVector3D desiredAngularMomentumAboutOrigin = new YoFrameVector3D("angularMomentumAboutOrigin", ReferenceFrame.getWorldFrame(), registry);
   private final YoFrameVector3D desiredAngularMomentumAboutCoM = new YoFrameVector3D("angularMomentumAboutCoM", ReferenceFrame.getWorldFrame(), registry);
